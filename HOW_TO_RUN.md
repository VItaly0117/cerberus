...
## Получить все результаты одной командой

После завершения 72-часового прогона (или в любой момент), просто запусти:

```bash
~/project-cerberus/get_results.sh
```

Выведет:
- ✅ Основные метрики (total_signals, successful, blocked, etc)
- 💰 P&L и медианный edge
- 📈 Топ 10 рынков по количеству сигналов
- 📅 P&L по дням
- ⚡ Процент успешных сделок
- 📄 Полный JSON отчёт (красиво отформатирован)
