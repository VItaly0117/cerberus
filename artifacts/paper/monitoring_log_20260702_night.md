...
## 2026-07-03 23:17 EEST

- Процесс жив (PID 83684).
- Всего paper_signals: 5011
- result breakdown: {'FILTERED': 5011}
- hourly_attempt_cap упоминаний: 0
- Уникальных рынков: 8

## 2026-07-04 00:17 EEST

- Процесс жив (PID 83684).
- Всего paper_signals: 5424
- result breakdown: {'FILTERED': 5424}
- hourly_attempt_cap упоминаний: 0
- Уникальных рынков: 8

## 01:12 EEST (2026-07-04) — ОСТАНОВЛЕНО (по решению пользователя)

YES+NO арбитраж признан статистически закрытым вопросом (5795 сигналов,
эдж стабильно отрицательный, максимум за всё время -0.45%). Остановлено
по решению пользователя, не из-за сбоя:
- cerberustest.py (PID 83684) — SIGTERM, остановился чисто.
- resolvertest.py (PID 6427) — SIGTERM, остановился чисто.
- caffeinate (PID 96048) — завершился сам вслед за PID 83684.
- launchd job com.cerberus.papermonitor — выгружен (launchctl unload).
- tmux-сессия cerberus_dashboard — закрыта.

Финальный экспорт БД и агрегатов: artifacts/paper/final_20260704/.
Финальный вывод зафиксирован в profitability_judge_panel_20260702.md
(секция CLOSED в начале файла).

Это последняя запись в данном логе наблюдения — мониторинг остановлен
вместе с прогоном.
